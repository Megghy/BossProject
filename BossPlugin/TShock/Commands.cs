...
namespace TShockAPI
{
    ...
    public class CommandArgs : EventArgs
    {
        ...
        public string CommandName { get { return Message.Split(' ')[0]; } }
    ...
    public static class Commands
    {
        ...
        public static void Whisper(CommandArgs args)
        {
            ...
            else
            {
                ...
                if (args.CommandName.Equals("w", StringComparison.CurrentCultureIgnoreCase))
                {
                    plr.SendMessage(msg, color: Color.MediumPurple);
                }
                else
                {
