...
namespace BossFramework.BHooks
{
    public static class HookHandler
    {
        ...
        internal static void HandleHooks()
        {
            ...
            PlayerHooks.PlayerHasBuildPermission += (PlayerHasBuildPermissionEventArgs args) =>
            {
                args.Result = args.Player.HasPermission("tshock.world.modify") ? PermissionHookResult.Granted : PermissionHookResult.Unhandled;
            };
