...
namespace TrProtocol.Models
{
    ...
    public partial struct ProtocolBitsByte
    {
        ...
        public ProtocolBitsByte(bool b1 = false, bool b2 = false, bool b3 = false, bool b4 = false, bool b5 = false, bool b6 = false, bool b7 = false, bool b8 = false)
        {
            this.value = 0;
            this[0] = b1;
            this[1] = b2;
        ...
        {
            this.Retrieve(ref b0, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null);
        }

        // Token: 0x060000E8 RID: 232 RVA: 0x00005120 File Offset: 0x00003320
        public void Retrieve(ref bool b0, ref bool b1)
        {
            this.Retrieve(ref b0, ref b1, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null);
        }

        // Token: 0x060000E9 RID: 233 RVA: 0x00005154 File Offset: 0x00003354
        public void Retrieve(ref bool b0, ref bool b1, ref bool b2)
        {
            this.Retrieve(ref b0, ref b1, ref b2, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null);
        }
        ...
        {
            this.Retrieve(ref b0, ref b1, ref b2, ref b3, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null);
        }
        ...
        {
            this.Retrieve(ref b0, ref b1, ref b2, ref b3, ref b4, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null);
        }
        ...
        {
            this.Retrieve(ref b0, ref b1, ref b2, ref b3, ref b4, ref b5, ref ProtocolBitsByte.Null, ref ProtocolBitsByte.Null);
        }
        ...
        {
            this.Retrieve(ref b0, ref b1, ref b2, ref b3, ref b4, ref b5, ref b6, ref ProtocolBitsByte.Null);
        }
        ...
        public static implicit operator byte(ProtocolBitsByte bb)
        {
            return bb.value;
        }

        // Token: 0x060000F0 RID: 240 RVA: 0x0000528C File Offset: 0x0000348C
        public static implicit operator ProtocolBitsByte(byte b)
        {
            return new ProtocolBitsByte
            {
                value = b
            };
        }
        ...
        public static ProtocolBitsByte[] ComposeBitsBytesChain(bool optimizeLength, params bool[] flags)
        {
            int i = flags.Length;
            int num = 0;
            while (i > 0)
            ...
            ProtocolBitsByte[] array = new ProtocolBitsByte[num];
            int num2 = 0;
            int num3 = 0;
            ...
            if (optimizeLength)
            {
                ...
                Array.Resize<ProtocolBitsByte>(ref array, num4 + 1);
            }
            return array;
        }
        ...
        public static implicit operator BitsByte(ProtocolBitsByte b)
            => b.value;
        public static implicit operator ProtocolBitsByte(BitsByte b)
            => b.value;
    }
}
